...
public class Drawing3ApplicationContextAware{
    /**
    ...
    public static void main(String[] args) {
        ...
        ApplicationContext context = new FileSystemXmlApplicationContext(
                "mvclogindb/src/main/java/basic/mytry/proj4Drawing/beansTriangle3ApplicationContextAware.xml");
        Triangle3ApplicationContextAware triangle = (Triangle3ApplicationContextAware) context.getBean("triangle");
        triangle.draw();
