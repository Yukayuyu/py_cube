...
silent only
silent tabonly
cd ~/code/py_cube/algorithm_visualisation_Java/misc
...
argglobal
if bufexists("test4.java~") | buffer test4.java~ | else | edit test4.java~ | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
2
normal! 06|
lcd ~/code/py_cube/algorithm_visualisation_Java/misc
wincmd w
argglobal
if bufexists("~/code/py_cube/algorithm_visualisation_Java/misc") | buffer ~/code/py_cube/algorithm_visualisation_Java/misc | else | edit ~/code/py_cube/algorithm_visualisation_Java/misc | endif
let s:cpo_save=&cpo
set cpo&vim
...
exe '2resize ' . ((&lines * 9 + 25) / 50)
tabnext
edit ~/code/py_cube/algorithm_visualisation_Java/misc/text8.java
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
tabnext 2
set stal=1
badd +1 ~/code/py_cube/algorithm_visualisation_Java/misc/text9.java
badd +0 ~/code/py_cube/algorithm_visualisation_Java/misc/text8.java
badd +1 ~/code/py_cube/algorithm_visualisation_Java/misc/test1.java
badd +1 ~/code/py_cube/algorithm_visualisation_Java/misc/test2.java
badd +4 ~/code/py_cube/algorithm_visualisation_Java/misc/Cp0_Array3D.java
badd +0 ~/code/py_cube/algorithm_visualisation_Java/misc/test4.java~
